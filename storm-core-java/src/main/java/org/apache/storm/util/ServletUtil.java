...
public class ServletUtil {
  ...
  public static PrintWriter initHTML(ServletResponse response, String title)
    ...
    out.println("<html>\n"
        + "<link rel='stylesheet' type='text/css' href='/static/css/jstorm.css'>\n"
        + "<title>" + title + "</title>\n" + "<body>\n" + "<h1>" + title
        + "</h1>\n");
    return out;
  }
  ...
  public static final String HTML_TAIL = "<hr />\n"
      + "<a href='http://jstorm.tencent.com/core'>JStorm</a>, "
  ...
  /**
   * Generate the percentage graph and returns HTML representation string of the
   * same.
   * 
   ...
   * @throws IOException
   */
  public static String percentageGraph(float perc, int width)
      throws IOException {
