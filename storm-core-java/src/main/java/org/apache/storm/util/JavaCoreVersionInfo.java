...
public class JavaCoreVersionInfo {
  private Properties info;

  protected JavaCoreVersionInfo(String component) {
    info = new Properties();
  ...
  protected String _getBuildVersion() {
    return getVersion() + " from " + _getRevision() + " by " + _getUser()
        + " source checksum " + _getSrcChecksum();
  }

  private static JavaCoreVersionInfo COMMON_VERSION_INFO =
      new JavaCoreVersionInfo("java-core");
