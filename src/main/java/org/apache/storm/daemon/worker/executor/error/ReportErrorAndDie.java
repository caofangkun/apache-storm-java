 ...
 * 
 */
@ClojureClass(className = "backtype.storm.daemon.executor#mk-executor-data:report-error-and-die")
public class ReportErrorAndDie extends RunnableCallback {
  ...
  public ReportErrorAndDie(ITaskReportErr _reporterror, RunnableCallback _haltfn) {
