...
public class ClusterTest {
  ...
  public void testStormClusterStateBasics() {
    try {
      ...
      Assert.assertNull("testStormClusterStateBasics failed", e);
    }
  }
  ...
  public void testSupervisorState() {
    try {
      ...
      SupervisorInfo info1 =
          new SupervisorInfo(1, "localhost", null, new HashSet<Integer>(),
              null, null, 2, null);
      SupervisorInfo info2 =
          new SupervisorInfo(3, "localhost", null, new HashSet<Integer>(),
              null, null, 4, null);
      state2.supervisorHeartbeat("2", info2);
      state1.supervisorHeartbeat("1", info1);

      Assert.assertEquals(info2, state1.supervisorInfo("2"));
      Assert.assertEquals(info1, state1.supervisorInfo("1"));
  ...
  @Test
  public void testMaybeDeserialize() {
    byte[] tmp = null;
